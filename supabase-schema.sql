-- shared pomodoro: esquema de base de datos
...
create policy "lectura publica" on public.sessions for
select
  using (true);

create policy "insercion publica" on public.sessions for insert
with
  check (true);
